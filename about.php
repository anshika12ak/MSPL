...
$clients = [
    ...
    ["name" => "Think Sys", "img" => "assets/image/thinksys.jpg", "bg" => "#ffffff"],
...
<head>
    ...
    <title>About Mithila Softech | IT & Software Experts India</title>
    ...
    <style>
        ...
        @keyframes bgScroll { 0% { background-position: 0 0; } 100% { background-position: 30px 30px; } }
        ...
        .reveal { opacity: 0; transform: translateY(36px) scale(0.96); transition: opacity 0.6s cubic-bezier(0.22, 1, 0.36, 1), transform 0.6s cubic-bezier(0.22, 1, 0.36, 1); transition-delay: var(--delay, 0s); }
    ...
    <div class="container content-container" style="position: relative; z-index: 2;">
        ...
        <div class="intro-grid">
            <div class="intro-text">
                ...
                <h2 class="reveal" style="transition-delay: 0.05s;">Best Digital Solutions <br><span>for Modern Businesses</span></h2>
            ...
            <div class="intro-image-wrap reveal" style="transition-delay: 0.3s;">
                <img src="assets/image/digitalseva.jpg" alt="about Mithila Softech team" loading="lazy">
            </div>
        </div>
        ...
        <p class="reveal" style="transition-delay: 0.25s; margin-bottom: 60px;">Our journey has been fueled by a commitment to quality, a deep understanding of our clients' needs, and an unwavering focus on delivering measurable results. Today, we stand proud as a trusted technology partner for startups, enterprises, and government initiatives alike.</p>

        <!-- Vision and Mission Section -->
        <div class="mission-vision-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; margin-bottom: 50px;">
            <div class="vision-card reveal" style="background: #ffffff; border: 1px solid var(--line); border-radius: 24px; padding: 40px 30px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.03); transition: transform 0.4s ease, box-shadow 0.4s ease;" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 20px 40px rgba(29, 78, 158, 0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 30px rgba(0,0,0,0.03)'">
                <h3 style="font-size: 1.6rem; font-weight: 800; margin-bottom: 16px; color: var(--text);">Our <span style="color: var(--blue);">Vision</span></h3>
                <p style="color: var(--muted); line-height: 1.7; font-size: 0.95rem; margin-bottom: 15px;">To be a globally recognized technology partner that empowers businesses to achieve digital excellence. We envision a future driven by:</p>
                <ul style="list-style: disc; padding-left: 20px; margin: 0 auto; color: var(--muted); font-size: 0.95rem; line-height: 1.8; text-align: left; display: inline-block;">
                    <li>Scalable & Innovative IT Solutions</li>
                    <li>Global Digital Transformation</li>
                    <li>Exponential Business Growth</li>
                    <li>Lasting Value for Enterprises</li>
                </ul>
            </div>
            
            <div class="mission-card reveal" style="transition-delay: 0.1s; background: #ffffff; border: 1px solid var(--line); border-radius: 24px; padding: 40px 30px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.03); transition: transform 0.4s ease, box-shadow 0.4s ease;" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 20px 40px rgba(227, 30, 36, 0.1)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 30px rgba(0,0,0,0.03)'">
                <h3 style="font-size: 1.6rem; font-weight: 800; margin-bottom: 16px; color: var(--text);">Our <span style="color: var(--accent);">Mission</span></h3>
                <p style="color: var(--muted); line-height: 1.7; font-size: 0.95rem; margin-bottom: 15px;">To deliver high-quality, customized software, ERP, and digital marketing services that solve real-world problems. We are committed to:</p>
                <ul style="list-style: disc; padding-left: 20px; margin: 0 auto; color: var(--muted); font-size: 0.95rem; line-height: 1.8; text-align: left; display: inline-block;">
                    <li>Fostering Continuous Innovation</li>
                    <li>Maintaining Absolute Transparency</li>
                    <li>Ensuring Unmatched Client Success</li>
                    <li>Providing Dedicated Tech Support</li>
                </ul>
            </div>
        </div>
...
<section class="section stats-section" style="background: linear-gradient(135deg, var(--green-dark) 0%, var(--blue-dark) 100%); position: relative; overflow: hidden; padding: 72px 0;">
...
<section class="section cs-section" id="partners" style="background: linear-gradient(180deg, #f8f9fa 0%, #ffffff 100%); padding: 60px 0; position: relative; overflow: hidden;">
    <div class="cs-bg-orb1" style="position: absolute; width: 400px; height: 400px; border-radius: 50%; filter: blur(100px); background: radial-gradient(circle, rgba(152,55,212,0.06) 0%, transparent 70%); left: -80px; top: 0; pointer-events: none;"></div>
    <div class="cs-bg-orb2" style="position: absolute; width: 400px; height: 400px; border-radius: 50%; filter: blur(100px); background: radial-gradient(circle, rgba(34,168,75,0.08) 0%, transparent 70%); right: -60px; bottom: 0; pointer-events: none;"></div>
    ...
    <div class="container content-container" style="position: relative; z-index: 2;">
        ...
        <div style="margin-top: 40px; margin-bottom: 60px;">
            ...
            <div class="testimonials-slider-wrapper reveal" style="transition-delay: 0.25s;">
                <div class="testimonials-track" id="aboutTestimonialsTrack" style="gap: 20px;">
                ...
                <div class="testimonial-view-more-side">
                    <button type="button" class="button button-primary" style="border-radius: 999px;" onclick="toggleTestimonials('aboutTestimonialsTrack', this)">View More</button>
                </div>
                <?php endif; ?>
            </div>
        </div>
