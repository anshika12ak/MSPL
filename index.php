...
$blogs = [
    [
        ...
        "excerpt" => "Businesses today need more than a standard website. Learn how custom web applications automate operations, improve customer experiences, strengthen security, and support scalable business growth.",
        "date" => "July 4, 2026",
        "category" => "Technology",
        "img" => "assets/image/web-application-development-company.png",
    ...
    [
        ...
        "excerpt" => "Custom CRM software development helps businesses organize customer data, automate repetitive tasks, improve communication, and increase sales efficiency through a centralized platform.",
        "date" => "July 3, 2026",
        "category" => "Technology",
        "img" => "assets/image/custom-crm-software-development-services.png",
    ...
    [
        ...
        "excerpt" => "A custom ERP system integrates finance, inventory, HR, CRM, sales, and operations into one platform so businesses can automate workflows, reduce costs, and make faster decisions.",
        "date" => "July 2, 2026",
        "category" => "Technology",
        "img" => "assets/image/erp-software-development-company-india.png",
  ...
  [
    ...
    "excerpt" => "Digital transformation is redefining business operations with automation, customer experiences, data-driven decisions, and agile systems.",
    "date" => "May 10, 2026",
    "category" => "Business",
