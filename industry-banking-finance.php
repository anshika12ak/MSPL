...
$industry_data = [
    ...
    "desc" => "Leverage fintech expertise to develop secure payment gateways, digital wallets, and intelligent banking portals.",
...
<head>
    ...
    <title>Banking & Finance Software Solutions | Fintech IT</title>
    ...
    <style>
        ...
        .srv-hero-wrapper {
            text-align: center;
            overflow: hidden;
            background: linear-gradient(135deg, rgba(2, 6, 23, 0.85), rgba(21, 58, 117, 0.85)), url('assets/image/banking.jpg') center/cover no-repeat;
    ...
    <div class="container content-container" style="position: relative; z-index: 2;">
        <div class="intro-grid">
            <div class="intro-text">
                <span class="eyebrow reveal">FinTech Solutions</span>
                <h2 class="reveal" style="transition-delay: 0.05s;">Modernize Operations with <span>Smart Banking</span></h2>
            ...
            <div class="intro-image-wrap reveal" style="transition-delay: 0.3s;">
                <img src="<?php echo htmlspecialchars($industry_data['gallery'][0]); ?>" alt="fintech software solutions India" loading="lazy">
            </div>
        </div>
        ...
        <div class="service-features-grid">
            <div class="feature-card reveal" style="transition-delay: 0.1s;">
                ...
                <p>Develop custom, ultra-secure payment gateways supporting multi-currency transactions and real-time fraud detection.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.2s;">
                ...
                <p>Build frictionless mobile wallet applications allowing users to store cards, track expenses, and transfer money instantly.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.3s;">
                ...
                <p>We engineer systems with military-grade encryption that adhere to strict financial regulations like PCI-DSS and GDPR.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.4s;">
                ...
                <h3>Robo Advisors & Analytics</h3>
                <p>Implement AI-driven algorithms and predictive analytics dashboards to provide automated financial advice and insights.</p>
            </div>
        </div>

        <span class="eyebrow reveal">Our Offerings</span>
        <h3 class="reveal" style="transition-delay: 0.05s;">Our <span>FinTech Services</span></h3>
        <ul class="reveal" style="transition-delay: 0.15s;">
            <li><strong>Core Banking Portals:</strong> Secure web platforms for retail and corporate banking with seamless CRM integrations.</li>
            <li><strong>Lending & Loan Software:</strong> Automated loan origination, credit scoring, and collection management systems.</li>
            <li><strong>Blockchain & Smart Contracts:</strong> Decentralized ledger technology for transparent and immutable financial ledgers.</li>
            <li><strong>InsureTech Solutions:</strong> Custom software for insurance quoting, policy management, and rapid claims processing.</li>
        </ul>
        ...
        <p class="reveal" style="transition-delay: 0.15s;">In finance, there is no room for error. We follow a highly structured development cycle focusing heavily on security testing and risk mitigation.</p>
        <div class="process-grid">
            <div class="process-card reveal" style="transition-delay: 0.1s;">
                <div class="card-top"><div class="process-step-num">1</div></div>
                <h3 style="margin-top: 16px;">Discovery & Compliance</h3><p>We map out your business objectives and define the strict regulatory landscape the product must operate within.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.2s;">
                <div class="card-top"><div class="process-step-num">2</div></div>
                <h3 style="margin-top: 16px;">Secure Architecture</h3><p>Our cloud architects design scalable infrastructures focusing heavily on data encryption and disaster recovery.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.3s;">
                <div class="card-top"><div class="process-step-num">3</div></div>
                <h3 style="margin-top: 16px;">Agile Development</h3><p>We develop your application iteratively, securely integrating third-party APIs for payments and data verification.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.4s;">
                <div class="card-top"><div class="process-step-num">4</div></div>
                <h3 style="margin-top: 16px;">VAPT & Launch</h3><p>We perform rigorous Vulnerability Assessment and Penetration Testing before securely launching your product.</p>
            </div>
        </div>

        <div class="tech-stack-section">
            <span class="eyebrow reveal">Tech Stack</span>
            <h2 class="reveal" style="transition-delay: 0.05s;">Technologies for <span>FinTech</span></h2>
            <p class="reveal" style="transition-delay: 0.15s;">We utilize enterprise-grade, highly secure technologies to build reliable financial software.</p>
            <div class="tech-stack-grid">
                <div class="tech-item reveal" style="transition-delay: 0.1s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>Digital Payments & Mobile Wallets</div>
                <div class="tech-item reveal" style="transition-delay: 0.15s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg>Blockchain & Cryptocurrency</div>
                <div class="tech-item reveal" style="transition-delay: 0.2s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2" ry="2"></rect><rect x="9" y="9" width="6" height="6"></rect><line x1="9" y1="1" x2="9" y2="4"></line><line x1="15" y1="1" x2="15" y2="4"></line><line x1="9" y1="20" x2="9" y2="23"></line><line x1="15" y1="20" x2="15" y2="23"></line><line x1="20" y1="9" x2="23" y2="9"></line><line x1="20" y1="14" x2="23" y2="14"></line><line x1="1" y1="9" x2="4" y2="9"></line><line x1="1" y1="14" x2="4" y2="14"></line></svg>AI & Machine Learning</div>
                <div class="tech-item reveal" style="transition-delay: 0.25s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"></path></svg>Cloud Computing</div>
                <div class="tech-item reveal" style="transition-delay: 0.3s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>Cybersecurity & Encryption</div>
                <div class="tech-item reveal" style="transition-delay: 0.35s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>Big Data & Analytics</div>
                <div class="tech-item reveal" style="transition-delay: 0.4s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>API Integration</div>
                <div class="tech-item reveal" style="transition-delay: 0.45s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>Robo-Advisors</div>
                <div class="tech-item reveal" style="transition-delay: 0.5s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg>Digital Banking Apps</div>
            </div>
        </div>
