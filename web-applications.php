...
<head>
    ...
    <style>
        .srv-hero-wrapper {
            ...
            background: linear-gradient(135deg, rgba(2, 6, 23, 0.92), rgba(21, 58, 117, 0.85)), url('https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=1920&q=80') center/cover no-repeat;
    ...
    <div class="container content-container" style="position: relative; z-index: 2;">
        <div class="intro-grid">
            <div class="intro-text">
                <span class="eyebrow reveal">Web App Solutions</span>
                <h2 class="reveal" style="transition-delay: 0.05s;">Powerful Web Applications for <span>Modern Businesses</span></h2>
                <p class="reveal" style="transition-delay: 0.15s;">Static websites aren't always enough to handle complex business requirements. We build dynamic, data-driven web applications that function like native software but are accessible directly through your browser.</p>
                <p class="reveal" style="transition-delay: 0.25s;">From interactive SaaS platforms and customer portals to custom internal dashboards, our web apps are built for speed, security, and extreme scalability using the latest modern JavaScript frameworks.</p>
            </div>
            <div class="intro-image-wrap reveal" style="transition-delay: 0.3s;">
                <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80" alt="Dynamic Web Applications" loading="lazy">
            </div>
        </div>
        ...
        <div class="service-features-grid">
            <div class="feature-card reveal" style="transition-delay: 0.1s;">
                ...
                <p>We architect applications capable of processing and pushing real-time data, ensuring your dashboards and users always have the latest information instantly.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.2s;">
                ...
                <h3>Intuitive Dashboards & UI</h3>
                <p>Complex data requires simple interfaces. We design highly intuitive admin panels and user dashboards that make managing your business effortless.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.3s;">
                ...
                <p>Built cloud-native from day one. Our applications are deployed on robust infrastructures like AWS or Azure to ensure they scale seamlessly as you grow.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.4s;">
                ...
                <p>We connect your web application to external services seamlessly, integrating payment gateways, CRMs, maps, messaging platforms, and more.</p>
            </div>
        </div>

        <span class="eyebrow reveal">Our Offerings</span>
        <h3 class="reveal" style="transition-delay: 0.05s;">Our <span>Web App Services</span></h3>
        <ul class="reveal" style="transition-delay: 0.15s;">
            <li><strong>Single Page Applications (SPAs):</strong> Lightning-fast applications that load a single HTML page and dynamically update as the user interacts.</li>
            <li><strong>Progressive Web Apps (PWAs):</strong> Web apps that look and feel like native mobile applications, complete with offline capabilities and push notifications.</li>
            <li><strong>Custom Enterprise Portals:</strong> Secure, role-based internal portals tailored for enterprise resource planning and workforce management.</li>
            <li><strong>SaaS Product Development:</strong> End-to-end architecture and engineering for your scalable Software-as-a-Service product idea.</li>
        </ul>
        ...
        <div class="process-grid">
            <div class="process-card reveal" style="transition-delay: 0.1s;">
                ...
                <h3 style="margin-top: 16px;">Architecture Planning</h3><p>We blueprint the entire system, mapping out databases, API endpoints, and user flows to ensure a solid foundation.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.2s;">
                <div class="card-top"><div class="process-step-num">2</div></div>
                <h3 style="margin-top: 16px;">Frontend & Backend Design</h3><p>Our teams work in parallel to craft the visual interface and engineer the robust server-side logic powering the app.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.3s;">
                <div class="card-top"><div class="process-step-num">3</div></div>
                <h3 style="margin-top: 16px;">Agile Development</h3><p>We build in iterative sprints, giving you constant visibility into progress and the ability to test features as they are completed.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.4s;">
                <div class="card-top"><div class="process-step-num">4</div></div>
                <h3 style="margin-top: 16px;">QA & Deployment</h3><p>After strict code reviews and security testing, we deploy your application to a live, production-ready cloud environment.</p>
            </div>
        </div>
        ...
        <div class="why-choose-list">
            <div class="why-item reveal" style="transition-delay: 0.1s;">
                <div class="card-top" style="margin-bottom: 8px;"><h4>Future-proof Tech Stack</h4></div>
                <p>We use modern, community-backed frameworks like React and Node.js so your code never becomes obsolete.</p>
            </div>
            <div class="why-item reveal" style="transition-delay: 0.2s;">
                <div class="card-top" style="margin-bottom: 8px;"><h4>Cross-platform Compatibility</h4></div>
                <p>Your web app will function perfectly regardless of whether your users are on a desktop, tablet, or mobile device.</p>
            </div>
            <div class="why-item reveal" style="transition-delay: 0.3s;">
                <div class="card-top" style="margin-bottom: 8px;"><h4>Robust Security Protocols</h4></div>
                <p>We implement strict data encryption, secure authentication (JWT/OAuth), and defense against common web vulnerabilities (OWASP).</p>
            </div>
        </div>
        ...
        <div class="tech-stack-section">
            ...
            <p class="reveal" style="transition-delay: 0.15s;">We leverage the best modern technologies to ensure your web application is powerful, fast, and secure.</p>
