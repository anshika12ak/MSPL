...
$industry_data = [
    ...
    "detail" => "The industry is perennially advancing with the constant changes in logistics and transportation. The race to provide cheaper, faster services remains fiercely competitive. To increase output value, it is necessary to have technologies that are economical and easily manageable with minimum training. We design supply chain management systems to make the transportation and logistics process transparent, automated, and simple.",
    "gallery" => [
...
<head>
    ...
    <title>Logistics Software Solutions | Transport IT Systems</title>
    ...
    <style>
        ...
        .srv-hero-wrapper {
            text-align: center;
            overflow: hidden;
            background: linear-gradient(135deg, rgba(2, 6, 23, 0.85), rgba(21, 58, 117, 0.85)), url('assets/image/DigitalLogistics.jpg') center/cover no-repeat;
    ...
    <div class="container content-container" style="position: relative; z-index: 2;">
        <div class="intro-grid">
            <div class="intro-text">
                <span class="eyebrow reveal">Supply Chain Tech</span>
                <h2 class="reveal" style="transition-delay: 0.05s;">Digital Logistics for <span>Seamless Operations</span></h2>
            ...
            <div class="intro-image-wrap reveal" style="transition-delay: 0.3s;">
                <img src="<?php echo htmlspecialchars($industry_data['gallery'][0]); ?>" alt="logistics tracking software system" loading="lazy">
            </div>
        </div>
        ...
        <div class="service-features-grid">
            <div class="feature-card reveal" style="transition-delay: 0.1s;">
                <div class="card-top">
                    <div class="feature-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"></polygon><line x1="9" y1="3" x2="9" y2="18"></line><line x1="15" y1="6" x2="15" y2="21"></line></svg></div>
                </div>
                <h3>Fleet & Route Management</h3>
                <p>Develop centralized fleet management systems with GPS tracking to optimize routes, reduce fuel consumption, and monitor vehicle health.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.2s;">
                ...
                <h3>Order Tracking & Visibility</h3>
                <p>Build customer-facing and internal tracking portals to provide end-to-end real-time visibility of shipments from origin to destination.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.3s;">
                ...
                <p>Implement Warehouse Management Systems (WMS) to streamline inventory tracking, smart order picking, and automated dispatching.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.4s;">
                <div class="card-top">
                    <div class="feature-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg></div>
                </div>
                <h3>Supply Chain Analytics</h3>
                <p>Leverage big data and custom dashboards to analyze supply chain bottlenecks, forecast demand, and make data-driven logistical decisions.</p>
            </div>
        </div>

        <span class="eyebrow reveal">Our Offerings</span>
        <h3 class="reveal" style="transition-delay: 0.05s;">Our <span>Logistics IT Services</span></h3>
        <ul class="reveal" style="transition-delay: 0.15s;">
            <li><strong>Transportation Management Systems (TMS):</strong> Centralized platforms to plan, execute, and optimize the physical movement of goods.</li>
            <li><strong>Warehouse Management Systems (WMS):</strong> Software for inventory control, barcode scanning, and space optimization.</li>
            <li><strong>Last-Mile Delivery Apps:</strong> Mobile applications for drivers and customers to ensure efficient and transparent final-step deliveries.</li>
            <li><strong>Fleet Telematics & IoT:</strong> Integration of smart sensors to monitor vehicle location, driver behavior, and cargo conditions in real time.</li>
        </ul>
        ...
        <p class="reveal" style="transition-delay: 0.15s;">We build logistics solutions focusing on high availability, real-time data accuracy, and seamless integration with your existing legacy systems.</p>
        <div class="process-grid">
            <div class="process-card reveal" style="transition-delay: 0.1s;">
                <div class="card-top"><div class="process-step-num">1</div></div>
                <h3 style="margin-top: 16px;">Operational Audit</h3><p>We analyze your current supply chain workflows and identify gaps where automation and tracking can be implemented.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.2s;">
                <div class="card-top"><div class="process-step-num">2</div></div>
                <h3 style="margin-top: 16px;">System Architecture</h3><p>We design scalable architectures that can handle massive data streams from GPS devices, APIs, and mobile users simultaneously.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.3s;">
                <div class="card-top"><div class="process-step-num">3</div></div>
                <h3 style="margin-top: 16px;">Integration & Development</h3><p>Our engineering team builds the solution iteratively, ensuring flawless integration with mapping providers and hardware sensors.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.4s;">
                <div class="card-top"><div class="process-step-num">4</div></div>
                <h3 style="margin-top: 16px;">Deployment & Training</h3><p>We deploy the platforms with minimal operational downtime and provide comprehensive training for your dispatchers and drivers.</p>
            </div>
        </div>

        <div class="tech-stack-section">
            <span class="eyebrow reveal">Tech Stack</span>
            <h2 class="reveal" style="transition-delay: 0.05s;">Technologies for <span>Logistics</span></h2>
            <p class="reveal" style="transition-delay: 0.15s;">We rely on powerful, highly available cloud infrastructures and advanced mapping APIs to keep your supply chain moving.</p>
            <div class="tech-stack-grid">
                <div class="tech-item reveal" style="transition-delay: 0.1s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>Google Maps & Mapbox APIs</div>
                <div class="tech-item reveal" style="transition-delay: 0.15s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg>React Native / Flutter</div>
                <div class="tech-item reveal" style="transition-delay: 0.2s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.55a11 11 0 0 1 14.08 0"></path><path d="M1.42 9a16 16 0 0 1 21.16 0"></path><path d="M8.53 16.11a6 6 0 0 1 6.95 0"></path><line x1="12" y1="20" x2="12.01" y2="20"></line></svg>IoT & Telematics Data</div>
                <div class="tech-item reveal" style="transition-delay: 0.25s;"><svg viewBox="0 0 24 24"><path d="M12.001 2.012c5.518 0 10.002 4.484 10.002 10.001 0 5.518-4.484 10.002-10.002 10.002-5.518 0-10.001-4.484-10.001-10.002 0-5.517 4.483-10.001 10.001-10.001zm-2.003 14.53l5.632-5.632-1.416-1.414-4.216 4.216-2.098-2.098-1.416 1.414 3.514 3.514z"/></svg>Node.js / Express</div>
                <div class="tech-item reveal" style="transition-delay: 0.3s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"></path><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"></path></svg>PostgreSQL / MongoDB</div>
                <div class="tech-item reveal" style="transition-delay: 0.35s;"><svg viewBox="0 0 24 24"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"></path></svg>AWS / Microsoft Azure</div>
                <div class="tech-item reveal" style="transition-delay: 0.4s;"><svg viewBox="0 0 24 24"><path d="M13.983 11.278h2.119a.186.186 0 00.186-.186V9.006a.186.186 0 00-.186-.186h-2.119a.186.186 0 00-.186.186v2.086c0 .103.083.186.186.186zm-2.95 0h2.119a.186.186 0 00.186-.186V9.006a.186.186 0 00-.186-.186h-2.119a.186.186 0 00-.186.186v2.086c0 .103.083.186.186.186zm-2.95 0h2.119a.186.186 0 00.186-.186V9.006a.186.186 0 00-.186-.186H8.083a.186.186 0 00-.186.186v2.086c0 .103.083.186.186.186zm-2.95 0h2.119a.186.186 0 00.186-.186V9.006a.186.186 0 00-.186-.186H5.133a.186.186 0 00-.186.186v2.086c0 .103.083.186.186.186zm5.9-2.842h2.119a.186.186 0 00.186-.186V6.164a.186.186 0 00-.186-.186h-2.119a.186.186 0 00-.186.186v2.086c0 .103.083.186.186.186zm-2.95 0h2.119a.186.186 0 00.186-.186V6.164a.186.186 0 00-.186-.186H8.083a.186.186 0 00-.186.186v2.086c0 .103.083.186.186.186zm-2.95 0h2.119a.186.186 0 00.186-.186V6.164a.186.186 0 00-.186-.186H5.133a.186.186 0 00-.186.186v2.086c0 .103.083.186.186.186zm2.95-2.842h2.119a.186.186 0 00.186-.186V3.322a.186.186 0 00-.186-.186H8.083a.186.186 0 00-.186.186v2.086c0 .103.083.186.186.186zM24 10.743c-.021-1.077-.941-1.954-2.023-1.954l-1.096.012c-.172-1.393-1.423-2.45-2.889-2.45-.04 0-.08.001-.12.003L17.75 6.31a.186.186 0 00-.184.148l-.348 1.488H17.11a.186.186 0 00-.186.186v3.298c0 .083.055.155.133.178.694.204 1.485.312 2.316.312 4.417 0 4.622-2.95 4.627-3.177zM.186 11.65h16.738a.186.186 0 01.186.186c0 3.754-3.055 6.809-6.809 6.809H7.135a4.238 4.238 0 01-3.69-2.164L0 11.836a.186.186 0 01.186-.186z"/></svg>Docker & Kubernetes</div>
                <div class="tech-item reveal" style="transition-delay: 0.4s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>Advanced Analytics</div>
            </div>
        </div>
