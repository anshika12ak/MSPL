...
<head>
    ...
    <style>
        ...
        .srv-hero-wrapper {
            text-align: center;
            overflow: hidden;
            background: linear-gradient(135deg, rgba(2, 6, 23, 0.85), rgba(21, 58, 117, 0.85)), url('assets/image/recruitment.png') center/cover no-repeat;
        ...
        .tech-stack-grid { display: grid; grid-template-columns: repeat(5, 1fr); gap: 20px; margin-top: 32px; }
        .tech-item { position: relative; z-index: 1; overflow: hidden; padding: 24px; display: flex; flex-direction: column; align-items: center; gap: 12px; font-weight: 600; color: var(--text); background: var(--card); border: 1px solid var(--line); border-radius: 20px; box-shadow: var(--shadow); transition: transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow 0.4s cubic-bezier(0.34, 1.56, 0.64, 1), border-color 0.4s ease, color 0.3s ease; text-align: center; line-height: 1.4;}
        ...
        @media (max-width: 768px) {
            ...
            .tech-stack-grid { gap: 16px; margin-top: 24px; grid-template-columns: repeat(2, 1fr); }
    ...
    <div class="container content-container" style="position: relative; z-index: 2;">
        ...
        <div class="intro-grid">
            <div class="intro-text">
                <span class="eyebrow reveal">IT Staffing</span>
                <h2 class="reveal" style="transition-delay: 0.05s;">Find the Right Talent for <span>Your Growth</span></h2>
                <p class="reveal" style="transition-delay: 0.15s;">Building a strong technical team is critical to your business's success. At Mithila Softech, we don't just forward resumes; we find the perfect cultural and technical fit.</p>
                <p class="reveal" style="transition-delay: 0.25s;">Leveraging our deep expertise as a functioning IT agency, our comprehensive recruitment services connect you with top-tier developers, engineers, and executives who align perfectly with your organizational goals.</p>
            </div>
            <div class="intro-image-wrap reveal" style="transition-delay: 0.3s;">
                <img src="assets/image/recruitment.png" alt="IT recruitment process India" loading="lazy">
            </div>
        </div>
        ...
        <div class="service-features-grid">
            <div class="feature-card reveal" style="transition-delay: 0.1s;">
                ...
                <p>Source experienced frontend/backend developers, UI/UX designers, and cloud engineers with verified technical skills.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.2s;">
                ...
                <p>Dedicated headhunting for C-suite, VP, and high-level technical leadership positions to guide your company's strategic vision.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.3s;">
                ...
                <h3>Contract & Remote Hiring</h3>
                <p>Flexible hiring models designed for short-term project demands or setting up dedicated offshore development centers.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.4s;">
                ...
                <h3>Rigorous Tech Screening</h3>
                <p>In-depth interview and vetting processes conducted by our own internal tech experts to guarantee candidate code quality.</p>
            </div>
        </div>

        <span class="eyebrow reveal">Our Offerings</span>
        <h3 class="reveal" style="transition-delay: 0.05s;">Roles We <span>Specialize In</span></h3>
        <ul class="reveal" style="transition-delay: 0.15s;">
            <li><strong>Software Engineering:</strong> Frontend (React/Vue), Backend (Node.js/Python), Full-Stack, and Mobile (Flutter/iOS/Android) Developers.</li>
            <li><strong>Data & Cloud:</strong> DevOps Engineers, Cloud Architects (AWS/Azure), Data Scientists, and Database Administrators.</li>
            <li><strong>Product & Design:</strong> UI/UX Designers, Product Managers, Scrum Masters, and Business Analysts.</li>
            <li><strong>Quality & Security:</strong> QA Automation Testers, Cyber Security Analysts, and Penetration Testers.</li>
        </ul>

        <span class="eyebrow reveal" style="margin-top: 40px;">How We Work</span>
        <h3 class="reveal" style="transition-delay: 0.05s; margin-top: 10px;">Our <span>Recruitment Process</span></h3>
        <p class="reveal" style="transition-delay: 0.15s;">We take a systematic, results-driven approach to ensure that every candidate we present is a strong match for your open positions.</p>
        <div class="process-grid">
            <div class="process-card reveal" style="transition-delay: 0.1s;">
                <div class="card-top"><div class="process-step-num">1</div></div>
                <h3 style="margin-top: 16px;">Requirement Analysis</h3><p>We deeply analyze your business needs, technical stack, and team culture to build a precise candidate persona.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.2s;">
                <div class="card-top"><div class="process-step-num">2</div></div>
                <h3 style="margin-top: 16px;">Sourcing & Outreach</h3><p>Using our extensive network and advanced sourcing tools, we identify passive and active candidates who match the profile.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.3s;">
                <div class="card-top"><div class="process-step-num">3</div></div>
                <h3 style="margin-top: 16px;">Screening & Vetting</h3><p>Our internal technical teams conduct rigorous preliminary interviews and live coding assessments to ensure high quality.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.4s;">
                <div class="card-top"><div class="process-step-num">4</div></div>
                <h3 style="margin-top: 16px;">Placement & Onboarding</h3><p>We facilitate seamless interviews, handle offer negotiations, and support the candidate through successful onboarding.</p>
            </div>
        </div>

        <div class="tech-stack-section">
            <span class="eyebrow reveal">Hiring Tools</span>
            <h2 class="reveal" style="transition-delay: 0.05s;">Tools <span>We Use</span></h2>
            <p class="reveal" style="transition-delay: 0.15s;">We utilize enterprise-grade ATS systems and technical screening platforms to streamline talent acquisition.</p>
            <div class="tech-stack-grid">
                <div class="tech-item reveal" style="transition-delay: 0.1s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>LinkedIn Recruiter</div>
                <div class="tech-item reveal" style="transition-delay: 0.15s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>Modern ATS (Workable)</div>
                <div class="tech-item reveal" style="transition-delay: 0.2s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>HackerRank / Codility</div>
                <div class="tech-item reveal" style="transition-delay: 0.25s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"></path></svg>Naukri & Monster</div>
                <div class="tech-item reveal" style="transition-delay: 0.3s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg>Background Verification</div>
            </div>
        </div>
