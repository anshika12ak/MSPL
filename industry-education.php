...
$industry_data = [
    "title" => "Education",
    "desc" => "School management systems, learning platforms, and EdTech solutions designed for modern educators and institutions.",
    ...
    "detail" => "All Aspects of Your School & Education Managed. Our expert team of professionals has designed comprehensive management systems and interactive e-learning platforms for educational institutions to meet the specific and diverse requirements of schools, colleges, professional institutions, and universities. We build scalable EdTech solutions that enhance remote learning, automate fee management, and boost student engagement.",
    "gallery" => [
...
<head>
    ...
    <title>Education Software Solutions | EdTech Development</title>
    ...
    <style>
        ...
        .srv-hero-wrapper {
            text-align: center;
            overflow: hidden;
            background: linear-gradient(135deg, rgba(2, 6, 23, 0.85), rgba(21, 58, 117, 0.85)), url('assets/image/educationindustry.jpg') center/cover no-repeat;
...
f         .feature-card:hover::before, .process-card:hover::before, .why-item:hover::before { opacity: 1; }
        ...
        .tech-stack-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 24px; margin-top: 32px; }
        .tech-item { 
    ...
    <div class="container content-container" style="position: relative; z-index: 2;">
        <div class="intro-grid">
            <div class="intro-text">
                <span class="eyebrow reveal">Education Technology</span>
                <h2 class="reveal" style="transition-delay: 0.05s;">Digital Tools for <span>Modern Learning</span></h2>
            ...
            <div class="intro-image-wrap reveal" style="transition-delay: 0.3s;">
                <img src="<?php echo htmlspecialchars($industry_data['gallery'][0]); ?>" alt="eLearning platform dashboard" loading="lazy">
            </div>
        </div>
        ...
        <div class="service-features-grid">
            <div class="feature-card reveal" style="transition-delay: 0.1s;">
                ...
                <h3>School Management ERP</h3>
                <p>Automate admissions, attendance tracking, fee collection, and HR management in a single, unified institutional system.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.2s;">
                <div class="card-top">
                    <div class="feature-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg></div>
                </div>
                <h3>Learning Management (LMS)</h3>
                <p>Deliver courses, track student progress, and manage assignments effortlessly with a robust e-learning platform.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.3s;">
                <div class="card-top">
                    <div class="feature-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"></polygon><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect></svg></div>
                </div>
                <h3>Virtual Classrooms</h3>
                <p>Integrate secure, high-quality video conferencing and interactive whiteboards for remote or hybrid learning environments.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.4s;">
                ...
                <p>Provide real-time access to grades, timetables, and direct communication channels connecting teachers and parents.</p>
            </div>
        </div>

        <span class="eyebrow reveal">Our Offerings</span>
        <h3 class="reveal" style="transition-delay: 0.05s;">Our <span>EdTech Services</span></h3>
        <ul class="reveal" style="transition-delay: 0.15s;">
            <li><strong>Examination & Result Management:</strong> Secure online assessment tools with automated grading and transcript generation.</li>
            <li><strong>Library & Transport Management:</strong> Track physical and digital library resources alongside GPS-enabled school bus tracking.</li>
            <li><strong>EdTech Mobile Apps:</strong> Custom Android and iOS applications that bring the classroom directly to students' fingertips.</li>
            <li><strong>Alumni Networks:</strong> Dedicated portals to keep alumni engaged, fostering community and future fundraising opportunities.</li>
        </ul>
        ...
        <p class="reveal" style="transition-delay: 0.15s;">We build education platforms focusing on intuitive design, strict data security, and scalability for large student populations.</p>
        <div class="process-grid">
            <div class="process-card reveal" style="transition-delay: 0.1s;">
                <div class="card-top"><div class="process-step-num">1</div></div>
                <h3 style="margin-top: 16px;">Requirements & Planning</h3><p>We map out your institutional workflow, from initial student admissions all the way to graduation processing.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.2s;">
                <div class="card-top"><div class="process-step-num">2</div></div>
                <h3 style="margin-top: 16px;">UI/UX for Education</h3><p>We design highly intuitive interfaces suitable for all digital literacy levels, from young students to parents and staff.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.3s;">
                <div class="card-top"><div class="process-step-num">3</div></div>
                <h3 style="margin-top: 16px;">Secure Development</h3><p>We build the system prioritizing data privacy, ensuring strict compliance with local educational data standards.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.4s;">
                <div class="card-top"><div class="process-step-num">4</div></div>
                <h3 style="margin-top: 16px;">Deployment & Training</h3><p>We integrate the software seamlessly and train your administrative and teaching staff for a smooth digital transition.</p>
            </div>
        </div>

        <div class="tech-stack-section">
            <span class="eyebrow reveal">Tech Stack</span>
            <h2 class="reveal" style="transition-delay: 0.05s;">Technologies for <span>Education</span></h2>
            <p class="reveal" style="transition-delay: 0.15s;">We utilize robust, secure frameworks optimized for video streaming and massive concurrent users.</p>
            <div class="tech-stack-grid">
                <div class="tech-item reveal" style="transition-delay: 0.1s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>React & Next.js</div>
                <div class="tech-item reveal" style="transition-delay: 0.15s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>Node.js & Python</div>
                <div class="tech-item reveal" style="transition-delay: 0.2s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6"></path><path d="M9 21H3v-6"></path><path d="M21 3l-7 7"></path><path d="M3 21l7-7"></path></svg>PostgreSQL / MongoDB</div>
                <div class="tech-item reveal" style="transition-delay: 0.25s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="23 7 16 12 23 17 23 7"></polygon><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect></svg>WebRTC / Zoom APIs</div>
                <div class="tech-item reveal" style="transition-delay: 0.3s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"></path></svg>AWS / Cloud Storage</div>
                <div class="tech-item reveal" style="transition-delay: 0.35s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg>Flutter & React Native</div>
                <div class="tech-item reveal" style="transition-delay: 0.4s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"></rect><line x1="2" y1="10" x2="22" y2="10"></line></svg>Payment Gateways (Stripe/Razorpay)</div>
                <div class="tech-item reveal" style="transition-delay: 0.45s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>Analytics & Reporting</div>
            </div>
        </div>
