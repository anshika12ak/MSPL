...
<head>
    ...
    <style>
        .srv-hero-wrapper {
            ...
            background: linear-gradient(135deg, rgba(2, 6, 23, 0.92), rgba(76, 34, 106, 0.85)), url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1920&q=80') center/cover no-repeat;
        ...
        .tech-item { flex: 1 1 140px; max-width: 240px; position: relative; z-index: 1; overflow: hidden; padding: 24px; display: flex; flex-direction: column; align-items: center; gap: 12px; font-weight: 600; color: var(--text); background: var(--card); border: 1px solid var(--line); border-radius: 20px; box-shadow: var(--shadow); transition: transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow 0.4s cubic-bezier(0.34, 1.56, 0.64, 1), border-color 0.4s ease, color 0.3s ease; }
    ...
    <div class="container content-container" style="position: relative; z-index: 2;">
        <div class="intro-grid">
            <div class="intro-text">
                <span class="eyebrow reveal">Paid Advertising</span>
                <h2 class="reveal" style="transition-delay: 0.05s;">Maximize ROI with <span>Precision Advertising</span></h2>
                <p class="reveal" style="transition-delay: 0.15s;">Stop wasting ad spend on campaigns that don't convert. We specialize in creating highly targeted pay-per-click (PPC) campaigns that put your brand directly in front of people actively looking for your products or services.</p>
                <p class="reveal" style="transition-delay: 0.25s;">From capturing high-intent search traffic via Google Ads to generating massive awareness and impulse buys through visually stunning Meta (Facebook & Instagram) campaigns, our experts optimize every single penny to ensure maximum Return on Ad Spend (ROAS).</p>
            </div>
            <div class="intro-image-wrap reveal" style="transition-delay: 0.3s;">
                <img src="https://images.unsplash.com/photo-1533750516457-a7f992034fec?auto=format&fit=crop&w=800&q=80" alt="Paid Advertising Campaign Management" loading="lazy">
            </div>
        </div>
        ...
        <div class="service-features-grid">
            <div class="feature-card reveal" style="transition-delay: 0.1s;">
                ...
                <p>Capture users at the exact moment they search for your services. We craft compelling search ads and visually striking display ads across Google's massive network.</p>
            </div>
            ...
            <div class="feature-card reveal" style="transition-delay: 0.3s;">
                <div class="card-top">
                    <div class="feature-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.5 2v6h-6M21.34 15.57a10 10 0 1 1-.59-9.21l-5.41 5.41"></path></svg></div>
                </div>
                <h3>Remarketing & Retargeting</h3>
                <p>Don't let interested visitors slip away. We build strategic retargeting funnels that follow your past visitors, bringing them back to complete their purchase.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.4s;">
                <div class="card-top">
                    <div class="feature-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg></div>
                </div>
                <h3>Conversion Tracking</h3>
                <p>We implement flawless pixel tracking and Google Tag Manager setups to ensure every conversion is attributed perfectly back to your ad spend.</p>
            </div>
        </div>

        <span class="eyebrow reveal">Our Offerings</span>
        <h3 class="reveal" style="transition-delay: 0.05s;">Campaign <span>Specialties</span></h3>
        <ul class="reveal" style="transition-delay: 0.15s;">
            <li><strong>Lead Generation Campaigns:</strong> Form-fill campaigns designed to capture B2B inquiries, appointment bookings, and high-value prospect data.</li>
            <li><strong>E-Commerce & Shopping Ads:</strong> Google Shopping feeds and Dynamic Product Ads on Meta that showcase your exact inventory to ready-to-buy shoppers.</li>
            <li><strong>Local Service Ads:</strong> Geo-fenced campaigns pushing calls and foot traffic straight to your local brick-and-mortar storefronts.</li>
            <li><strong>App Install Campaigns:</strong> Driving cost-effective downloads and active user engagement for your new mobile applications.</li>
        </ul>

        <span class="eyebrow reveal" style="margin-top: 40px;">How We Work</span>
        <h3 class="reveal" style="transition-delay: 0.05s; margin-top: 10px;">Our <span>Ad Management Process</span></h3>
        <p class="reveal" style="transition-delay: 0.15s;">We don't just 'set and forget'. Our dedicated media buyers actively manage your campaigns daily to continually push your cost-per-acquisition lower.</p>
        <div class="process-grid">
            ...
            <div class="process-card reveal" style="transition-delay: 0.2s;">
                ...
                <h3 style="margin-top: 16px;">Audience & Targeting</h3><p>We build highly detailed customer avatars, utilizing lookalike audiences, custom intent targeting, and rigorous keyword research.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.3s;">
                <div class="card-top"><div class="process-step-num">3</div></div>
                <h3 style="margin-top: 16px;">Ad Creation & Launch</h3><p>Our creative team designs compelling ad graphics and writes persuasive copy engineered specifically to drive high click-through rates.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.4s;">
                <div class="card-top"><div class="process-step-num">4</div></div>
                <h3 style="margin-top: 16px;">A/B Testing & Scaling</h3><p>We constantly test headlines, imagery, and audiences. Winning campaigns get scaled up, while underperformers are immediately cut.</p>
            </div>
        </div>

        <div class="tech-stack-section">
            <span class="eyebrow reveal">Ad Tech</span>
            <h2 class="reveal" style="transition-delay: 0.05s;">Tools <span>We Master</span></h2>
            <p class="reveal" style="transition-delay: 0.15s;">We utilize the industry's most powerful ad platforms and analytics software to track every conversion.</p>
            <div class="tech-stack-grid">
                ...
                <div class="tech-item reveal" style="transition-delay: 0.2s;">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6.9 8.6a1.9 1.9 0 1 1 0-3.8 1.9 1.9 0 0 1 0 3.8zM5.3 20.3V10h3.2v10.3H5.3zm5 0V10h3.1v1.4h.1c.4-.8 1.5-1.7 3.2-1.7 3.4 0 4 2.2 4 5.1v5.5h-3.2v-4.9c0-1.2 0-2.6-1.6-2.6s-1.8 1.2-1.8 2.5v5h-3.8z"/></svg>
                    LinkedIn Ads
                </div>
