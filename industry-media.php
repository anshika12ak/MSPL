<?php
$activePage = 'industry';
$title = 'Media Industry Solutions | Mithila Softech';
...
<head>
    ...
    <title>Media & Entertainment IT Solutions | Digital Platforms</title>
    ...
    <style>
        ...
        .srv-hero-wrapper {
            text-align: center;
            overflow: hidden;
            background: linear-gradient(135deg, rgba(2, 6, 23, 0.85), rgba(21, 58, 117, 0.85)), url('assets/image/media.png') center/cover no-repeat;
        ...
        .srv-hero-badge {
            display: inline-flex; align-items: center; padding: 8px 18px; brder-radius: 999px;
        ...
        .tech-item svg { width: 36px; height: 36px; transition: transform 0.3s ease; }
...
<section class="srv-hero-wrapper">
    ...
    <div class="container" style="position: relative; z-index: 2;">
        <span class="srv-hero-badge">🎬 &nbsp; Media Solutions</span>
        <h1 class="srv-hero-headline">Media &amp; Entertainment <br><span class="srv-hero-headline-bold">Digital <span class="srv-hero-headline-accent">Solutions</span></span></h1>
    ...
    <div class="container content-container" style="position: relative; z-index: 2;">
        <div class="intro-grid">
            <div class="intro-text">
                <span class="eyebrow reveal">Media Solutions</span>
                <h2 class="reveal" style="transition-delay: 0.05s;">Engage Audiences at <span>Scale</span></h2>
            ...
            <div class="intro-image-wrap reveal" style="transition-delay: 0.3s;">
                <img src="<?php echo htmlspecialchars($industry_data['gallery'][0]); ?>" alt="media streaming platform UI" loading="lazy">
            </div>
        </div>
        ...
        <div class="service-features-grid">
            <div class="feature-card reveal" style="transition-delay: 0.1s;">
                <div class="card-top">
                    <div class="feature-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg></div>
                </div>
                <h3>Content Management (CMS)</h3>
                <p>Deploy headless CMS architectures that allow editors to publish rich content across websites, mobile apps, and smart TVs instantly.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.2s;">
                <div class="card-top">
                    <div class="feature-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg></div>
                </div>
                <h3>OTT & Video Streaming</h3>
                <p>Launch high-performance Video on Demand (VOD) and live streaming applications with adaptive bitrate delivery and DRM protection.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.3s;">
                <div class="card-top">
                    <div class="feature-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"></path><path d="M18.7 8l-5.1 5.2-2.8-2.7L7 14.3"></path></svg></div>
                </div>
                <h3>Audience Analytics</h3>
                <p>Collect and analyze viewer behavior data in real-time to personalize content recommendations and optimize engagement strategies.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.4s;">
                ...
                <h3>Subscription & Paywalls</h3>
                <p>Integrate robust subscription management systems and dynamic paywalls to successfully monetize your digital content.</p>
            </div>
        </div>

        <span class="eyebrow reveal">Our Offerings</span>
        <h3 class="reveal" style="transition-delay: 0.05s;">Our <span>Media IT Services</span></h3>
        <ul class="reveal" style="transition-delay: 0.15s;">
            <li><strong>News & Publishing Portals:</strong> High-traffic web platforms optimized for fast content delivery and SEO visibility.</li>
            <li><strong>Entertainment Apps:</strong> Immersive mobile applications for fan engagement, ticketing, and interactive experiences.</li>
            <li><strong>Digital Asset Management (DAM):</strong> Secure, cloud-based repositories for storing and categorizing massive media libraries.</li>
            <li><strong>Audio Streaming Platforms:</strong> Custom architecture for podcasts, radio streaming, and music delivery applications.</li>
        </ul>
        ...
        <p class="reveal" style="transition-delay: 0.15s;">We build media solutions focusing on rapid content delivery, high availability under traffic spikes, and flawless user experiences.</p>
        <div class="process-grid">
            <div class="process-card reveal" style="transition-delay: 0.1s;">
                <div class="card-top"><div class="process-step-num">1</div></div>
                <h3 style="margin-top: 16px;">Platform Strategy</h3><p>We analyze your content lifecycle and audience demographics to blueprint the optimal distribution architecture.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.2s;">
                <div class="card-top"><div class="process-step-num">2</div></div>
                <h3 style="margin-top: 16px;">UI/UX & Engagement</h3><p>We design visually rich, distraction-free interfaces that keep users engaged with your content longer.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.3s;">
                <div class="card-top"><div class="process-step-num">3</div></div>
                <h3 style="margin-top: 16px;">Cloud Engineering</h3><p>We build robust backends utilizing content delivery networks (CDNs) to ensure zero buffering and high performance globally.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.4s;">
                <div class="card-top"><div class="process-step-num">4</div></div>
                <h3 style="margin-top: 16px;">Launch & Monitor</h3><p>We deploy the platform with strict load-testing and continuous analytics monitoring to track audience retention.</p>
            </div>
        </div>

        <div class="tech-stack-section">
            <span class="eyebrow reveal">Tech Stack</span>
            <h2 class="reveal" style="transition-delay: 0.05s;">Technologies for <span>Media</span></h2>
            <p class="reveal" style="transition-delay: 0.15s;">We utilize cutting-edge cloud infrastructure to deliver high-quality media content to any device seamlessly.</p>
            <div class="tech-stack-grid">
                <div class="tech-item reveal" style="transition-delay: 0.1s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>Headless CMS Platforms</div>
                <div class="tech-item reveal" style="transition-delay: 0.15s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>Video Streaming APIs</div>
                <div class="tech-item reveal" style="transition-delay: 0.2s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>Content Delivery Networks</div>
                <div class="tech-item reveal" style="transition-delay: 0.25s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>Subscription & Paywalls</div>
                <div class="tech-item reveal" style="transition-delay: 0.3s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"></path><path d="M18.7 8l-5.1 5.2-2.8-2.7L7 14.3"></path></svg>Audience Data Analytics</div>
                <div class="tech-item reveal" style="transition-delay: 0.35s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"></path></svg>Cloud Media Storage</div>
                <div class="tech-item reveal" style="transition-delay: 0.4s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg>Interactive UI Frameworks</div>
                <div class="tech-item reveal" style="transition-delay: 0.45s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg>Cross-platform Mobile Apps</div>
            </div>
        </div>
