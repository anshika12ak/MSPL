<?php
$activePage = 'industry';
$title = 'Real Estate Industry Solutions | Mithila Softech';
...
<head>
    ...
    <title>Real Estate Software Solutions | Property IT Systems</title>
    ...
    <style>
        ...
        .srv-hero-wrapper {
            text-align: center;
            overflow: hidden;
            background: linear-gradient(135deg, rgba(2, 6, 23, 0.85), rgba(21, 58, 117, 0.85)), url('assets/image/realindustry.png') center/cover no-repeat;
...
<section class="srv-hero-wrapper">
    ...
    <div class="container" style="position: relative; z-index: 2;">
        <span class="srv-hero-badge">🏢 &nbsp; Real Estate Solutions</span>
        <h1 class="srv-hero-headline">Real Estate Software &amp; <br><span class="srv-hero-headline-bold">Property Management <span class="srv-hero-headline-accent">Solutions</span></span></h1>
    ...
    <div class="container content-container" style="position: relative; z-index: 2;">
        <div class="intro-grid">
            <div class="intro-text">
                <span class="eyebrow reveal">PropTech Solutions</span>
                <h2 class="reveal" style="transition-delay: 0.05s;">Digital Tools for <span>Modern Real Estate</span></h2>
            ...
            <div class="intro-image-wrap reveal" style="transition-delay: 0.3s;">
                <img src="<?php echo htmlspecialchars($industry_data['gallery'][0]); ?>" alt="real estate CRM dashboard" loading="lazy">
            </div>
        </div>
        ...
        <div class="service-features-grid">
            <div class="feature-card reveal" style="transition-delay: 0.1s;">
                ...
                <h3>Property Listing Portals</h3>
                <p>Develop scalable, SEO-optimized property listing platforms featuring advanced search filters, map integration, and virtual tours.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.2s;">
                <div class="card-top">
                    <div class="feature-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle></svg></div>
                </div>
                <h3>Real Estate CRM</h3>
                <p>Equip your sales team with robust lead management software to automate follow-ups, track interactions, and close deals faster.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.3s;">
                ...
                <p>Manage multiple construction projects simultaneously with dashboards that track progress, materials, and contractor deadlines in real-time.</p>
            </div>
            <div class="feature-card reveal" style="transition-delay: 0.4s;">
                ...
                <h3>Digital Contracts & Leases</h3>
                <p>Streamline document workflows with secure e-signature integrations and automated lease lifecycle management tools.</p>
            </div>
        </div>

        <span class="eyebrow reveal">Our Offerings</span>
        <h3 class="reveal" style="transition-delay: 0.05s;">Our <span>PropTech Services</span></h3>
        <ul class="reveal" style="transition-delay: 0.15s;">
            <li><strong>Property Management Apps:</strong> Mobile tools allowing tenants to pay rent, submit maintenance requests, and communicate with landlords.</li>
            <li><strong>MLS Data Integration:</strong> Seamless synchronization with Multiple Listing Services to keep your property inventory constantly updated.</li>
            <li><strong>Virtual Tour Software:</strong> Integrate 3D walkthroughs and augmented reality features directly into your property listings.</li>
            <li><strong>Smart Building IoT:</strong> Dashboards to monitor energy usage, security, and environmental controls for modern commercial properties.</li>
        </ul>
        ...
        <p class="reveal" style="transition-delay: 0.15s;">We build real estate solutions with a focus on visual appeal, data security, and seamless integration with your existing broker tools.</p>
        <div class="process-grid">
            <div class="process-card reveal" style="transition-delay: 0.1s;">
                <div class="card-top"><div class="process-step-num">1</div></div>
                <h3 style="margin-top: 16px;">Scope & Discovery</h3><p>We consult with your brokers and property managers to map out workflows and identify essential third-party integrations.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.2s;">
                <div class="card-top"><div class="process-step-num">2</div></div>
                <h3 style="margin-top: 16px;">Architecture & Design</h3><p>We design intuitive, high-end interfaces that showcase properties beautifully while keeping backend lead management simple.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.3s;">
                <div class="card-top"><div class="process-step-num">3</div></div>
                <h3 style="margin-top: 16px;">Agile Engineering</h3><p>We build out the platforms iteratively, connecting mapping APIs, CRMs, and payment gateways securely.</p>
            </div>
            <div class="process-card reveal" style="transition-delay: 0.4s;">
                <div class="card-top"><div class="process-step-num">4</div></div>
                <h3 style="margin-top: 16px;">Deployment</h3><p>We launch your application, optimize it for local search visibility, and provide ongoing support to your team.</p>
            </div>
        </div>

        <div class="tech-stack-section">
            <span class="eyebrow reveal">Tech Stack</span>
            <h2 class="reveal" style="transition-delay: 0.05s;">Technologies for <span>Real Estate</span></h2>
            <p class="reveal" style="transition-delay: 0.15s;">We utilize robust, enterprise-grade frameworks specifically chosen for massive data handling and visual performance.</p>
            <div class="tech-stack-grid">
                <div class="tech-item reveal" style="transition-delay: 0.1s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path></svg>MLS & Property APIs</div>
                <div class="tech-item reveal" style="transition-delay: 0.15s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle></svg>Real Estate CRM Systems</div>
                <div class="tech-item reveal" style="transition-delay: 0.2s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6"></path><path d="M9 21H3v-6"></path><path d="M21 3l-7 7"></path><path d="M3 21l7-7"></path></svg>Virtual Tours & 3D Modeling</div>
                <div class="tech-item reveal" style="transition-delay: 0.25s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>Geolocation & Maps</div>
                <div class="tech-item reveal" style="transition-delay: 0.3s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>Lead & Funnel Analytics</div>
                <div class="tech-item reveal" style="transition-delay: 0.35s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.55a11 11 0 0 1 14.08 0"></path><path d="M1.42 9a16 16 0 0 1 21.16 0"></path><path d="M8.53 16.11a6 6 0 0 1 6.95 0"></path><line x1="12" y1="20" x2="12.01" y2="20"></line></svg>Smart Building IoT</div>
                <div class="tech-item reveal" style="transition-delay: 0.4s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>Digital Lease & E-Signatures</div>
                <div class="tech-item reveal" style="transition-delay: 0.45s;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg>Property Mobile Apps</div>
            </div>
        </div>
